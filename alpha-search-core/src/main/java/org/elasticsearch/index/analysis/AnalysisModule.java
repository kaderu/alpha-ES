...
public class AnalysisModule extends AbstractModule {
    ...
    private static class DefaultProcessor extends AnalysisBinderProcessor {
        ...
        public void processTokenizers(TokenizersBindings tokenizersBindings) {
            ...
            tokenizersBindings.processTokenizer("separator", SeparatorTokenizerFactory.class);
        ...
        public void processAnalyzers(AnalyzersBindings analyzersBindings) {
            ...
            analyzersBindings.processAnalyzer("separator", SeparatorAnalyzerProvider.class);

...
# out.
JAVA_OPTS="$JAVA_OPTS -Xms${ES_MAX_MEM}"
JAVA_OPTS="$JAVA_OPTS -Xmx${ES_MAX_MEM}"
JAVA_OPTS="$JAVA_OPTS -XX:PermSize=${packaging.elasticsearch.perm.size}"
JAVA_OPTS="$JAVA_OPTS -XX:MaxPermSize=${packaging.elasticsearch.perm.max}"
JAVA_OPTS="$JAVA_OPTS -Xmn${ES_MIN_MEM} -XX:MaxNewSize=${ES_MIN_MEM}"
JAVA_OPTS="$JAVA_OPTS -XX:ReservedCodeCacheSize=${packaging.elasticsearch.codecache.max}"
